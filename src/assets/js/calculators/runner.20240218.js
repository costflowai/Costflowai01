...
export function wireCalculator(calculatorKey, config) {
  ...
  calculateButton.addEventListener('click', event => {
    ...
    if (typeof window !== 'undefined') {
      ...
      window.costflowai.calculations.set(calculatorKey, calculationPayload);
      window.costflowai.calculations.set('latest', calculationPayload);
    }
    ...
    publish('calculator:computed', calculationPayload);
