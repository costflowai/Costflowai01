import { wireCalculator, addRegionalPricing } from './runner.20240218.js';
import './concrete.20240218.js';
import './paint.20240218.js';
import './framing.20240218.js';

const INITIALIZED_FLAG = '__costflowai_calculators_init__';
...
export function initCalculators({ force } = {}) {
  if (typeof window !== 'undefined') {
    if (window[INITIALIZED_FLAG] && !force) {
      return;
    }
